...
final Map<String, String> synonymsUrls = const {
  'dart': '/dart/assets/dart-samples.xml',
  'js': '/dart/assets/js-samples.xml',
  'csharp': '/dart/assets/csharp-samples.xml',
  'java': '/dart/assets/java-samples.xml',
  'python': '/dart/assets/python-samples.xml'
};
...
const String transformUrl = "/dart/assets/transform.xslt";
